...
import osprey_adphone_hn.cellcom.com.cn.adapter.GwcDfspAdapter.ViewHolder;
...
public class GwcDfhspAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.os_dfhsp_item, null);
			...
			viewHolder.btn_txfh = (FButton) convertView
					.findViewById(R.id.btn_txfh);
