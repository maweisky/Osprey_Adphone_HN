 ...
 *
 */
public class DhbSyzxQhbLsActivity extends ActivityFrame implements
		IXListViewListener {
  ...
  private TextView tvTopTitle;
	...
	private void initListener() {
	  llAppBack.setOnClickListener(new OnClickListener() {
        ...
        public void onClick(View v) {
          // TODO Auto-generated method stub
          DhbSyzxQhbLsActivity.this.finish();
        }
      });
		...
		xListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				Intent intent = new Intent(DhbSyzxQhbLsActivity.this,
	...
	private void getRedPackInfos() {
		if (SharepreferenceUtil.readString(this, SharepreferenceUtil.fileName,
				"uid", "").equals("")) {
			Intent loginintent = new Intent(DhbSyzxQhbLsActivity.this,
					LoginActivity.class);
		...
		HttpHelper.getInstances(DhbSyzxQhbLsActivity.this).send(
