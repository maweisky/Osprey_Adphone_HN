...
import osprey_adphone_hn.cellcom.com.cn.zxing.camera.PlanarYUVLuminanceSource;
 ...
 * ����handler
 */
final class DecodeAddHandler extends Handler {
	private static final String TAG = DecodeAddHandler.class.getSimpleName();
	...
	DecodeAddHandler(CaptureAddActivity activity,
