 ...
 * ��activityһ��ʱ������û�з����
 * �ά�룬�ͽ���activity����Ϊ��ʱ�䲻�ϻ�ȡͼƬ��ĵ���Դ�п���ʹ����#
 */
public final class InactivityTimer {
	...
	/**
	 * 
	 * @Description:�رն�ʱ����Ͷ�ʱ��÷�����activity����ʱ�е��ã���4����ʱ����Ͷ�ʱ��
	 */
	...
	private static final class DaemonThreadFactory implements ThreadFactory {
		public Thread newThread(Runnable runnable) {
			/**
			 * �÷���4��threadFactory��ڣ���һ��runnable���󷵻�һ��thread���󣨰�
			 * װrunnbale��
			 */
			Thread thread = new Thread(runnable);
			/**
			 * ����Ϊ�ػ��̣߳����ƺ�̨���񣬵������û��߳̽���󣬸��̻߳��Զ�������Ϊ��activity�
			 * ����������ø� �̣߳�����ָFinishListener��Ϊ�ػ��̣߳��ͻᵼ�¸��߳��޷�����
			 */
