...
package osprey_adphone_hn.cellcom.com.cn.zxing.camera;
...
public final class CameraManager {
	...
	/**
	 * �����Ƿ���һ���Իص����Ϊtrue�Ļ�������һ�¾�ͣ�ˣ�������Ҫ���¶������յ�surface
	 */
	...
	/**
	 * Gets the CameraManager singleton instance. ����ģʽ
	 * 
	...
	/**
	 * Closes the camera driver if still in use. �ر����
	 */
	...
	/**
	 * Tells the camera to stop drawing preview frames. �����ͣ
	 */
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			if (screenResolution.x > screenResolution.y) {
				int width = screenResolution.y / 2;
				int height = screenResolution.y * 2 / 5;
				/**
				 * ��ߵĿ�ʼλ��Ϊ��Ļ���ȥ���ο��2���ϱ߿�ʼλ��ͬ������һ��
				 */
